 ...
 */
public class RtfloglevelConnectionProvider implements PoolingConnectionProvider<RtfloglevelConnection> {
  ...
  */
  ...
  @Override
  public void disconnect(RtfloglevelConnection connection) {
    try {
  ...
  @Override
  public ConnectionValidationResult validate(RtfloglevelConnection connection) {
